...
!function (a, b) {
    ...
    h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], g.pt.config = {
        ...
        0 == b.type && (!!window.ActiveXObject && !!document.documentMode) && a.layero.find(".layui-layer-title").width(a.layero.find(".layui-layer-btn").innerWidth() - 90),
