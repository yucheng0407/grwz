/**
 * Created by rxnew on 2017/11/22.
 */
/*
...
(function (q) {
    var H, I, J, K, L, M, u, s = {}, v = {}, w = {}, N = {
            ...
            a.bind(c.CLICK, function (a, c, h, k, g) {
            ...
            a.bind(c.ASYNC_SUCCESS, function (a, c, h, k) {
                j.apply(b.callback.onAsyncSuccess, [a, c, h, k])
            });
            a.bind(c.ASYNC_ERROR, function (a, c, h, k, g, f) {
                j.apply(b.callback.onAsyncError, [a, c, h, k, g, f])
            });
            a.bind(c.REMOVE, function (a, c, h) {
                j.apply(b.callback.onRemove, [a, c, h])
            });
            a.bind(c.SELECTED,
                function (a, c, h) {
                    j.apply(b.callback.onSelected, [c, h])
                });
            a.bind(c.UNSELECTED, function (a, c, h) {
                j.apply(b.callback.onUnSelected, [c, h])
            })
        }], y = [function (b) {
            var a = f.event;
            ...
            a.nodes = [];
            a.doms = []
        }], A = [function (b, a, c, d, e, h) {
            if (c) {
                var k = g.getRoot(b), f = b.data.key.children;
                c.level = a;
                ...
                c.getNextNode = function () {
                    return g.getNextNode(b,
                        c)
                };
                c.getIndex = function () {
                    return g.getNodeIndex(b, c)
                };
                c.getPath = function () {
                    return g.getNodePath(b, c)
                };
                c.isAjaxing = !1;
                g.fixPIdKeyValue(b, c)
            }
        }], t = [function (b) {
            var a = b.target, c = g.getSetting(b.data.treeId), d = "", e = null, h = "", k = "", o = null, i = null,
                l = null;
            if (j.eqs(b.type, "mousedown")) k = "mousedown"; else if (j.eqs(b.type, "mouseup")) k = "mouseup"; else if (j.eqs(b.type, "contextmenu")) k = "contextmenu"; else if (j.eqs(b.type, "click"))if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" + f.id.SWITCH) !== null) d = j.getNodeMainDom(a).id,
                h = "switchNode"; else {
                if (l = j.getMDom(c, a, [{
                        tagName: "a",
                        attrName: "treeNode" + f.id.A
                    }])) d = j.getNodeMainDom(l).id, h = "clickNode"
            } else if (j.eqs(b.type, "dblclick") && (k = "dblclick", l = j.getMDom(c, a, [{
                    tagName: "a",
                    attrName: "treeNode" + f.id.A
                }]))) d = j.getNodeMainDom(l).id, h = "switchNode";
            if (k.length > 0 && d.length == 0 && (l = j.getMDom(c, a, [{
                    tagName: "a",
                    attrName: "treeNode" + f.id.A
                }]))) d = j.getNodeMainDom(l).id;
            if (d.length > 0)switch (e = g.getNodeCache(c, d), h) {
                case "switchNode":
                    e.isParent ? j.eqs(b.type, "click") || j.eqs(b.type, "dblclick") &&
                    j.apply(c.view.dblClickExpand, [c.treeId, e], c.view.dblClickExpand) ? o = H : h = "" : h = "";
                    break;
                case "clickNode":
                    o = I
            }
            ...
            return {stop: !1, node: e, nodeEventType: h, nodeEventCallback: o, treeEventType: k, treeEventCallback: i}
        }], B = [function (b) {
            var a = g.getRoot(b);
            a || (a = {}, g.setRoot(b, a));
        ...
        C = [], D = [], E = [], F = [], G = [], g = {
            ...
            addCreatedNode: function (b, a) {
                ...
                if (!a)return null;
                for (var c = b.data.key.children, d = a.parentTId ? a.getParentNode() : g.getRoot(b), e = 0, h = d[c].length - 1; e <= h; e++)if (d[c][e] === a)return e;
                return -1
            }, getNextNode: function (b, a) {
                if (!a)return null;
                for (var c = b.data.key.children, d = a.parentTId ?
                    a.getParentNode() : g.getRoot(b), e = 0, h = d[c].length - 1; e <= h; e++)if (d[c][e] === a)return e == h ? null : d[c][e + 1];
                return null
            }, getNodeByParam: function (b, a, c, d) {
                if (!a || !c)return null;
                for (var e = b.data.key.children, h = 0, k = a.length; h < k; h++) {
                ...
                if (!a)return null;
                var c = w[b.treeId].nodes[g.getNodeCacheId(a)];
                return c ? c : null
                ...
                if (!a || !c)return [];
                for (var e = b.data.key.children, h = [], k = 0, f = a.length; k < f; k++)a[k][c] == d && h.push(a[k]), h = h.concat(g.getNodesByParam(b, a[k][e], c, d));
                return h
            }, getNodesByParamFuzzy: function (b, a, c, d) {
                if (!a || !c)return [];
                for (var e = b.data.key.children,
                         h = [], d = d.toLowerCase(), k = 0, f = a.length; k < f; k++)typeof a[k][c] == "string" && a[k][c].toLowerCase().indexOf(d) > -1 && h.push(a[k]), h = h.concat(g.getNodesByParamFuzzy(b, a[k][e], c, d));
                return h
            }, getNodesByFilter: function (b, a, c, d, e) {
                if (!a)return d ? null : [];
                for (var h = b.data.key.children, k = d ? null : [], f = 0, i = a.length; f < i; f++) {
                    if (j.apply(c, [a[f], e], !1)) {
                        if (d)return a[f];
                        k.push(a[f])
                    }
                    var l = g.getNodesByFilter(b, a[f][h], c, d, e);
                    if (d && l)return l;
                    k = d ? l : k.concat(l)
                }
                return k
                ...
                if (!a)return null;
                for (var c =
                    b.data.key.children, d = a.parentTId ? a.getParentNode() : g.getRoot(b), e = 0, h = d[c].length; e < h; e++)if (d[c][e] === a)return e == 0 ? null : d[c][e - 1];
                return null
            }, getRoot: function (b) {
                ...
                for (var k =
                    0, f = A.length; k < f; k++)A[k].apply(this, arguments)
            }, initRoot: function (b) {
                for (var a = 0, c = B.length; a < c; a++)B[a].apply(this, arguments)
            }, isSelectedNode: function (b, a) {
                for (var c = g.getRoot(b), d = 0, e = c.curSelectedList.length; d < e; d++)if (a === c.curSelectedList[d])return !0;
                return !1
            }, removeNodeCache: function (b, a) {
                var c = b.data.key.children;
                if (a[c])for (var d = 0, e = a[c].length; d < e; d++)g.removeNodeCache(b, a[c][d]);
                g.getCache(b).nodes[g.getNodeCacheId(a.tId)] = null
            }, removeSelectedNode: function (b, a) {
                for (var c = g.getRoot(b),
                         d = 0, e = c.curSelectedList.length; d < e; d++)if (a === c.curSelectedList[d] || !g.getNodeCache(b, c.curSelectedList[d].tId)) c.curSelectedList.splice(d, 1), b.treeObj.trigger(f.event.UNSELECTED, [b.treeId, a]), d--, e--
                ...
                if (j.isArray(a))for (var e = 0, h = a.length; e < h; e++)d.push(a[e]),
                a[e][c] && (d = d.concat(g.transformToArrayFormat(b, a[e][c]))); else d.push(a), a[c] && (d = d.concat(g.transformToArrayFormat(b, a[c])));
                return d
            }, transformTozTreeFormat: function (b, a) {
                var c, d, e = b.data.simpleData.idKey, h = b.data.simpleData.pIdKey, k = b.data.key.children;
                if (!e || e == "" || !a)return [];
                if (j.isArray(a)) {
                    var f = [], g = {};
                    for (c = 0, d = a.length; c < d; c++)g[a[c][e]] = a[c];
                    for (c = 0, d = a.length; c < d; c++)g[a[c][h]] && a[c][e] != a[c][h] ? (g[a[c][h]][k] || (g[a[c][h]][k] = []), g[a[c][h]][k].push(a[c])) : f.push(a[c]);
                    return f
                } else return [a]
            }
        },
        m = {
            bindEvent: function (b) {
                ...
                e; d++) {
                    var h = a[d];
                    h.nodeEventCallback && (c = h.nodeEventCallback.apply(h, [b, h.node]) && c);
                    h.treeEventCallback && (c = h.treeEventCallback.apply(h, [b, h.node]) && c)
                }
                return c
            }
        };
    ...
    I = function (b, a) {
        var c = g.getSetting(b.data.treeId), d = c.view.autoCancelSelected &&
        (b.ctrlKey || b.metaKey) && g.isSelectedNode(c, a) ? 0 : c.view.autoCancelSelected && (b.ctrlKey || b.metaKey) && c.view.selectedMulti ? 2 : 1;
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            if (!b.data.keep.leaf || !a || a.isParent)if (j.isArray(d) || (d = [d]), b.data.simpleData.enable && (d = g.transformTozTreeFormat(b, d)), a) {
                var h = l(a, f.id.SWITCH, b), k = l(a, f.id.ICON, b), o = l(a, f.id.UL, b);
                if (!a.open) i.replaceSwitchClass(a, h, f.folder.CLOSE),
                    i.replaceIcoClass(a, k, f.folder.CLOSE), a.open = !1, o.css({display: "none"});
                g.addNodesData(b, a, c, d);
                i.createNodes(b, a.level + 1, d, a, c);
                e || i.expandCollapseParentNode(b, a, !0)
            } else g.addNodesData(b, g.getRoot(b), c, d), i.createNodes(b, 0, d, null, c)
        }, appendNodes: function (b, a, c, d, e, h, k) {
            if (!c)return [];
            var f = [], j = b.data.key.children, l = (d ? d : g.getRoot(b))[j], r, P;
            if (!l || e >= l.length - c.length) e = -1;
            for (var m = 0, q = c.length; m < q; m++) {
                var n = c[m];
                h && (r = (e === 0 || l.length == c.length) && m == 0, P = e < 0 && m == c.length - 1, g.initNode(b, a, n, d,
                    r, P, k), g.addNodeCache(b, n));
                r = [];
                n[j] && n[j].length > 0 && (r = i.appendNodes(b, a + 1, n[j], n, -1, h, k && n.open));
                k && (i.makeDOMNodeMainBefore(f, b, n), i.makeDOMNodeLine(f, b, n), g.getBeforeA(b, n, f), i.makeDOMNodeNameBefore(f, b, n), g.getInnerBeforeA(b, n, f), i.makeDOMNodeIcon(f, b, n), g.getInnerAfterA(b, n, f), i.makeDOMNodeNameAfter(f, b, n), g.getAfterA(b, n, f), n.isParent && n.open && i.makeUlHtml(b, n, f, r.join("")), i.makeDOMNodeMainAfter(f, b, n), g.addCreatedNode(b, n))
            }
            return f
            ...
            for (e = 0, h = b.async.autoParam.length; a && e < h; e++) {
                var o = b.async.autoParam[e].split("="), p = o;
                o.length > 1 && (p = o[1], o = o[0]);
                k[p] = a[o]
            }
            if (j.isArray(b.async.otherParam))for (e = 0, h = b.async.otherParam.length; e < h; e += 2)k[b.async.otherParam[e]] = b.async.otherParam[e + 1]; else for (var m in b.async.otherParam)k[m] = b.async.otherParam[m];
            var r = g.getRoot(b)._ver;
            q.ajax({
                ...
                success: function (h) {
                    if (r == g.getRoot(b)._ver) {
                        var e = [];
                        try {
                            e = !h || h.length == 0 ? [] : typeof h == "string" ? eval("(" + h + ")") : h
                        } catch (k) {
                            e = h
                        }
                        ...
                        b.treeObj.trigger(f.event.ASYNC_SUCCESS, [b.treeId, a, h]);
                        j.apply(d)
                    }
                },
                error: function (c, d, h) {
                    if (r == g.getRoot(b)._ver) {
                        ...
                        i.setNodeLineIcos(b,
                            a);
                        b.treeObj.trigger(f.event.ASYNC_ERROR, [b.treeId, a, c, d, h])
                    }
                }
            });
            return !0
        }, cancelPreSelectedNode: function (b, a, c) {
            var d = g.getRoot(b).curSelectedList, e, h;
            for (e = d.length - 1; e >= 0; e--)if (h = d[e], a === h || !a && (!c || c !== h))if (l(h, f.id.A, b).removeClass(f.node.CURSELECTED), a) {
                g.removeSelectedNode(b, a);
                break
            } else d.splice(e, 1), b.treeObj.trigger(f.event.UNSELECTED, [b.treeId, h])
        }, createNodeCallback: function (b) {
            if (b.callback.onNodeCreated || b.view.addDiyDom)for (var a = g.getRoot(b); a.createdNodes.length > 0;) {
            ...
            if (c && c.length != 0) {
                var h = g.getRoot(b), k = b.data.key.children, k = !d || d.open || !!l(d[k][0], b).get(0);
                h.createdNodes = [];
                var a = i.appendNodes(b, a, c, d, e, !0, k), j, p;
                d ? (d = l(d, f.id.UL, b), d.get(0) && (j = d)) : j = b.treeObj;
                j && (e >= 0 && (p = j.children()[e]), e >= 0 && p ? q(p).before(a.join("")) : j.append(a.join("")));
                i.createNodeCallback(b)
            }
        }, destroy: function (b) {
            b && (g.initCache(b),
                g.initRoot(b), m.unbindTree(b), m.unbindEvent(b), b.treeObj.empty(), delete s[b.treeId])
        }, expandCollapseNode: function (b, a, c, d, e) {
            var h = g.getRoot(b), k = b.data.key.children, o;
            if (a) {
                if (h.expandTriggerFlag) o = e, e = function () {
                    o && o();
                ...
                if (a.open == c) j.apply(e,
                    []); else {
                    var c = l(a, f.id.UL, b), h = l(a, f.id.SWITCH, b), p = l(a, f.id.ICON, b);
                    a.isParent ? (a.open = !a.open, a.iconOpen && a.iconClose && p.attr("style", i.makeNodeIcoStyle(b, a)), a.open ? (i.replaceSwitchClass(a, h, f.folder.OPEN), i.replaceIcoClass(a, p, f.folder.OPEN), d == !1 || b.view.expandSpeed == "" ? (c.show(), j.apply(e, [])) : a[k] && a[k].length > 0 ? c.slideDown(b.view.expandSpeed, e) : (c.show(), j.apply(e, []))) : (i.replaceSwitchClass(a, h, f.folder.CLOSE), i.replaceIcoClass(a, p, f.folder.CLOSE), d == !1 || b.view.expandSpeed == "" || !(a[k] &&
            ...
            var h = g.getRoot(b), k = b.data.key.children, h = a ? a[k] : h[k], k = a ? !1 : d,
                f = g.getRoot(b).expandTriggerFlag;
            g.getRoot(b).expandTriggerFlag = !1;
            if (h)for (var j = 0, l = h.length; j <
            l; j++)h[j] && i.expandCollapseSonNode(b, h[j], c, k);
            g.getRoot(b).expandTriggerFlag = f;
            i.expandCollapseNode(b, a, c, d, e)
        }, isSelectedNode: function (b, a) {
            if (!a)return !1;
            var c = g.getRoot(b).curSelectedList, d;
        ...
        makeDOMNodeNameBefore: function (b, a, c) {
            var d = g.getNodeTitle(a, c), e = i.makeNodeUrl(a, c), h = i.makeNodeFontCss(a, c), k = [], o;
            for (o in h)k.push(o, ":", h[o], ";");
            ...
            if (a) {
                ...
                if (d) {
                    for (var e = 0, h = d.length; e < h; e++)g.removeNodeCache(b, d[e]);
            ...
            if (a)if (typeof Element === "undefined") {
                var c =
                    b.treeObj.get(0).getBoundingClientRect(), d = a.getBoundingClientRect();
                (d.top < c.top || d.bottom > c.bottom || d.right > c.right || d.left < c.left) && a.scrollIntoView()
            } else {
                if (!Element.prototype.scrollIntoViewIfNeeded) Element.prototype.scrollIntoViewIfNeeded = function (a) {
                    function b(a, c, d, e) {
                        return {
                            ...
                            right: a + d,
                            bottom: c + e,
                            translate: function (f, k) {
                                return b(f + a, k + c, d, e)
                            },
                            relativeFromTo: function (k, g) {
                                var i = a, j = c, k = k.offsetParent, g = g.offsetParent;
                                if (k === g)return f;
                                for (; k; k = k.offsetParent)i +=
                                    k.offsetLeft + k.clientLeft, j += k.offsetTop + k.clientTop;
                    ...
                    for (var c, d = this, f = b(this.offsetLeft, this.offsetTop, this.offsetWidth, this.offsetHeight); j.isElement(c = d.parentNode);) {
                        var g = c.offsetLeft + c.clientLeft, i = c.offsetTop + c.clientTop,
                            f = f.relativeFromTo(d, c).translate(-g, -i);
                        c.scrollLeft = !1 === a || f.left <= c.scrollLeft + c.clientWidth && c.scrollLeft <= f.right - c.clientWidth + c.clientWidth ? Math.min(f.left, Math.max(f.right -
                            c.clientWidth, c.scrollLeft)) : (f.right - c.clientWidth + f.left) / 2;
                        c.scrollTop = !1 === a || f.top <= c.scrollTop + c.clientHeight && c.scrollTop <= f.bottom - c.clientHeight + c.clientHeight ? Math.min(f.top, Math.max(f.bottom - c.clientHeight, c.scrollTop)) : (f.bottom - c.clientHeight + f.top) / 2;
                        f = f.translate(g - c.scrollLeft, i - c.scrollTop);
                        d = c
                    }
                };
            ...
            var c = g.getRoot(b), d = b.data.key.children, e = a.parentTId ? a.getParentNode() : c;
            a.isFirstNode = !1;
            a.isLastNode = !1;
            ...
            if (g.getNodeCache(b, a.tId)) {
                ...
                g.removeSelectedNode(b, a);
                for (var h = 0, k = e[d].length; h < k; h++)if (e[d][h].tId == a.tId) {
                    e[d].splice(h, 1);
                    break
                }
                i.setFirstNode(b, e);
                i.setLastNode(b, e);
                var j, h = e[d].length;
                if (!b.data.keep.parent && h == 0) e.isParent =
                    !1, e.open = !1, h = l(e, f.id.UL, b), k = l(e, f.id.SWITCH, b), j = l(e, f.id.ICON, b), i.replaceSwitchClass(e, k, f.folder.DOCU), i.replaceIcoClass(e, j, f.folder.DOCU), h.css("display", "none"); else if (b.view.showLine && h > 0) {
                    var p = e[d][h - 1], h = l(p, f.id.UL, b), k = l(p, f.id.SWITCH, b);
                    j = l(p, f.id.ICON, b);
                    e == c ? e[d].length == 1 ? i.replaceSwitchClass(p, k, f.line.ROOT) : (c = l(e[d][0], f.id.SWITCH, b), i.replaceSwitchClass(e[d][0], c, f.line.ROOTS), i.replaceSwitchClass(p, k, f.line.BOTTOM)) : i.replaceSwitchClass(p, k, f.line.BOTTOM);
        ...
        replaceIcoClass: function (b, a, c) {
            ...
            var c = l(a, f.id.A, b), d = i.makeNodeFontCss(b, a);
            d && c.css(d)
        }, setNodeLineIcos: function (b, a) {
            if (a) {
                var c = l(a, f.id.SWITCH, b), d = l(a, f.id.UL, b), e = l(a, f.id.ICON, b), h = i.makeUlLineClass(b, a);
                h.length ==
                0 ? d.removeClass(f.line.LINE) : d.addClass(h);
            ...
            var c = g.getNodeTitle(b, a), d = l(a, f.id.SPAN, b);
            d.empty();
        ...
        setNodeTarget: function (b, a) {
            ...
            var c = l(a, f.id.A, b), d = i.makeNodeUrl(b, a);
    ...
    q.fn.zTree = {
        consts: {
            ...
            tools: j,
            view: i, event: m, data: g
        }, getZTreeObj: function (b) {
            return (b = g.getZTreeTools(b)) ? b : null
        }, destroy: function (b) {
            if (b && b.length > 0) i.destroy(g.getSetting(b)); else for (var a in s)i.destroy(s[a])
        }, init: function (b, a, c) {
            var d = j.clone(N);
            q.extend(!0, d, a);
            d.treeId = b.attr("id");
            ...
            b[a] = d.data.simpleData.enable ? g.transformTozTreeFormat(d,
                c) : c;
            g.initCache(d);
            m.unbindTree(d);
            m.bindTree(d);
            ...
            var e = {
                setting: d, addNodes: function (a, b, c, e) {
                    ...
                    g.getRoot(d).expandTriggerFlag = f;
                    !j.canAsync(d,
                        a) && c ? i.expandCollapseSonNode(d, a, b, !0, m) : (a.open = !b, i.switchNode(this.setting, a), m());
                    return b
                }, getNodes: function () {
                    return g.getNodes(d)
                }, getNodeByParam: function (a, b, c) {
                    return !a ? null : g.getNodeByParam(d, c ? c[d.data.key.children] : g.getNodes(d), a, b)
                }, getNodeByTId: function (a) {
                    return g.getNodeCache(d, a)
                }, getNodesByParam: function (a, b, c) {
                    return !a ? null : g.getNodesByParam(d, c ? c[d.data.key.children] : g.getNodes(d), a, b)
                }, getNodesByParamFuzzy: function (a, b, c) {
                    return !a ? null : g.getNodesByParamFuzzy(d, c ? c[d.data.key.children] :
                        g.getNodes(d), a, b)
                }, getNodesByFilter: function (a, b, c, e) {
                    b = !!b;
                    return !a || typeof a != "function" ? b ? null : [] : g.getNodesByFilter(d, c ? c[d.data.key.children] : g.getNodes(d), a, b, e)
                }, getNodeIndex: function (a) {
                    if (!a)return null;
                    for (var b = d.data.key.children, c = a.parentTId ? a.getParentNode() : g.getRoot(d), e = 0, f = c[b].length; e < f; e++)if (c[b][e] == a)return e;
                    return -1
                }, getSelectedNodes: function () {
                    for (var a = [], b = g.getRoot(d).curSelectedList, c = 0, e = b.length; c < e; c++)a.push(b[c]);
                    return a
                }, isSelectedNode: function (a) {
                    return g.isSelectedNode(d,
                        a)
                    ...
                    var a = g.getRoot(d), b = a[d.data.key.children];
                    g.initRoot(d);
                    ...
                    return g.transformTozTreeFormat(d, a)
                }, transformToArray: function (a) {
                    return g.transformToArrayFormat(d, a)
                }, updateNode: function (a) {
                    a && l(a, d).get(0) && j.uCanDo(d) && (i.setNodeName(d, a), i.setNodeTarget(d, a), i.setNodeUrl(d, a), i.setNodeLineIcos(d, a), i.setNodeFontCss(d,
                        a))
                }
            };
            b.treeTools = e;
